      ...
      <div className="rounded-lg border overflow-hidden">
        <div className="overflow-x-auto">
          <table className="atterberg-table">
            <thead>
              <tr>
                <th className="w-10 sm:auto">Trial</th>
                <th>
                  ...
                  >
                    ...
                    <td className="px-1 sm:px-3 py-1.5">
                      <Input
                        ...
                        className={cn("h-7 sm:h-8 text-xs sm:text-sm text-center atterberg-input", started && !valid && !trial.initialLength && "border-amber-300")}
                        placeholder="140"
                      />
                    </td>
                    <td className="px-1 sm:px-3 py-1.5">
                      <Input
                        ...
                        className={cn("h-7 sm:h-8 text-xs sm:text-sm text-center atterberg-input", started && !valid && !trial.finalLength && "border-amber-300")}
                        placeholder="130"
                      />
                    </td>
                    <td className="px-1 sm:px-3 py-1.5 atterberg-calculated">
                      <span className="text-xs sm:text-sm">{shrinkagePct !== null ? `${shrinkagePct}%` : "-"}</span>
                    </td>
