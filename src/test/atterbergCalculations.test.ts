...
describe("calculateLiquidLimit (Cone Penetration BS 1377)", () => {
  it("should interpolate moisture at 20mm penetration", () => {
    ...
    // Log-linear regression (ASTM D4318): LL = m·log10(20) + b
    // From points (15, 35.20) and (25, 38.50): m ≈ 14.91, b ≈ 17.66
    // LL ≈ 14.91·log10(20) + 17.66 ≈ 37.05
    expect(result).toBeCloseTo(37.05, 1);
  });
